...
Und, das ist der unangenehmste Teil, die Datei wird benutzt. Wie oft, lässt sich von außen nicht sagen. Wer den Skill global in sein `~/.claude`-Verzeichnis installiert, taucht nirgends auf, diese Fälle sind schlicht nicht zählbar. Sichtbar werden nur die, die ihn in die Versionsverwaltung eingecheckt haben, so wie ein [Vertriebsprojekt](https://github.com/coopguadalupana/LeadsGuadalupana/blob/master/agent/skills/brand-landingpage/SKILL.md), ein [Demo-Agent](https://github.com/shikhar13012001/scheudrx-ultravox-demo-agent/blob/main/.agent/skills/brand-landingpage/SKILL.md) oder ein [Agenten-Baukasten](https://github.com/RudyCity/superagent/blob/main/.agents/skills/brand-landingpage/SKILL.md). Überall dieselbe Datei, samt der Adresse, die sich jederzeit wieder scharf stellen lässt.
