...
Ehrlicherweise bleibt eine Unsicherheit. AIR verlinkt den Skill nicht direkt, sondern beschreibt ihn nur. Alle Merkmale passen, aber beweisen lässt sich die Identität damit nicht. Theoretisch könnte ich hier auch einen Nachahmer gefunden haben, der dieselbe Masche kopiert hat.

Also habe ich nachgesehen, wem die Domain gehört, auf die der Skill verweist. Der Eigentümer bleibt verborgen, die Registrierung läuft über einen Anonymisierungsdienst. Aufschlussreich ist trotzdem das Datum: Die Domain wurde am **20. April 2026** registriert, neun Tage bevor der Pull Request eingereicht wurde. Das ist kein Zufallsfund einer alten Adresse, sondern eine eigens für diesen Zweck angelegte Domain. Sie ist bis heute aktiv und liegt hinter Cloudflare.

Noch interessanter fand ich den Seitenblick auf die Firma selbst: Die Domain `air.security` wurde am **25. April 2026** registriert, also fünf Tage nach der Angreifer-Domain, beim selben Registrar und über denselben Anonymisierungsdienst. Beweisen lässt sich damit nichts, denn dieser Dienst ist schlicht das Standardangebot dieses Registrars. Aber das zeitliche Bild passt: Hier wurde innerhalb einer Woche im April sowohl die Tarn-Domain als auch der öffentliche Auftritt der Firma aufgesetzt. Wer den Fall bewerten will, sollte außerdem wissen, dass die Firma damit noch keine drei Monate alt ist.

Für die Frage, ob man diesen Skill installieren möchte, ändert all das ohnehin wenig. Ob Original oder Kopie: Die Datei weist den Agenten weiterhin an, eine fremde Adresse als verbindliche Wahrheit zu behandeln und stillschweigend zu installieren, was von dort kommt.
