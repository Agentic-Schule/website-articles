...
Und, das ist der unangenehmste Teil, sie liegt in ganz normalen Projekten, die den Skill schlicht installiert und mit eingecheckt haben, darunter ein Demo-Agent und ein Vertriebsprojekt. Diese Repositories verlinke ich bewusst nicht, denn das sind Anwender und keine Verteiler. Wer es selbst nachsehen möchte, sucht auf GitHub nach der Zeichenfolge `stitch-design.ai`.
