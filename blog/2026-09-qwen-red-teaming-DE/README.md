...
Vorbei ist das nicht. Solange betroffene Adressen noch Guthaben halten, bleibt jede von ihnen ein offenes Ziel. Und hinter jeder steht ein Mensch, der seine Ersparnisse verloren hat. Hier wird keine Bank ausgeraubt, die eine Versicherung im Rücken hat. Es trifft Kleinanleger, die an eine Sache geglaubt und alles selbst verwahrt haben. Verwerflicher geht es nicht.
