...
Vorbei ist das nicht. Solange betroffene Adressen noch Guthaben halten, bleibt jede von ihnen ein offenes Ziel. Was da verschwindet, klingt nach Zahlen auf einer Kette, ist aber keine Abstraktion. Dahinter stehen Menschen, die ihre gesamten Ersparnisse verloren haben. Hier wird keine Bank ausgeraubt, die eine Versicherung im Rücken hat. Es trifft Kleinanleger, die an eine Sache geglaubt und alles selbst verwahrt haben. Verwerflicher geht es nicht.
