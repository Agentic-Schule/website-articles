...
- https://github.com/angular/web-codegen-scorer — Web Codegen Scorer vom Angular-Team (04.09.2026 per gh verifiziert: „a tool for evaluating the quality of web code generated by LLMs"; Use Cases wörtlich „Iterate on a system prompt to find most effective instructions for your project", „Compare the code quality of code produced by different models"; Built-in checks „build success, runtime errors, accessibility, security, LLM rating, and coding best practices"; Ziel „evidence-based decisions relating to AI-generated code"; Features wörtlich „Specify system instructions and add MCP servers.", „Automatically attempt to repair issues detected during code generating.", „View and compare results with an intuitive report viewer UI."; CLI-Flags u. a. `--autorater-model` (Modell fürs automatische Rating), `--runner` mit `ai-sdk` (Default), `gemini-cli`, `claude-code`, `codex`; Beispiel-Lauf `web-codegen-scorer eval --env=angular-example`; Haupt-Contributor devversion und crisbeto)
