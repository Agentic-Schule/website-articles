...
Anthropic, Microsoft, Google, OpenAI, Cursor, and Cognition noticed this long ago. The most exciting insight from my research: practically all agentic tools have arrived at the same pattern over the last one and a half years. **Locally, isolation means git worktree; in the cloud, it means a dedicated VM or container.**
