...
- **Es drauf ankommen lassen.** Schnell einen zweiten Agenten starten: stash, Branch wechseln, fixen, pushen und zurück, bevor der laufende Agent etwas merkt. Nur liest und schreibt der erste genau in diesem Verzeichnis. Wechseln wir darunter den Branch, editiert er ab sofort fremde Dateistände, und die Tests prüfen einen Zustand, den es so nie gegeben hat.
