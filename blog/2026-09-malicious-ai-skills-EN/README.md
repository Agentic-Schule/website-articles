---
title: 'Anatomy of a Malicious AI Skill: An Attack That Is Still Live'
...
The address only turns malicious when someone flips the switch. For the attack they replaced the content, and afterwards it went back to its resting state. As of 26 September 2026 the domain again answers with a redirect to the official address. Click the link today and you land on the original and happily tick off your check. Clicking the link therefore proves nothing whatsoever. It shows the state of this one moment, and that state belongs to somebody else.
...
So much for the story as AIR tells it. It ends with publication on 22 June. What interested me is what has happened since, so I went and looked. The part that genuinely surprised me: **the skill is still there.** As of 26 September 2026, the file `plugins/brand-landingpage/skills/brand-landingpage/SKILL.md` still contains both references to the attackers' domain, unchanged. That is a good three months after the report was published and almost five months after the merge. The repository itself is very much alive. It now counts more than 40,000 stars and keeps receiving new commits regularly.
