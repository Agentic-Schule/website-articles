...
Schon vor dem Fortune-Auftritt kursierte eine zugespitztere Fassung. Osmani zitiert Cherny in seinem Artikel mit „I don’t prompt Claude anymore. I have loops running that prompt Claude and figuring out what to do. My job is to write loops". Die Spur dieses Zitats führt allerdings zu einem inzwischen gelöschten X-Post, eine Primärquelle gibt es also nicht mehr. Und wörtlich nehmen sollte man es ohnehin nicht: Hier bewirbt der Chef sein eigenes Produkt. Wer selbst Schleifen laufen lässt, greift sehr wohl ein, justiert nach und bricht ab.
